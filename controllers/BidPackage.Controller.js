...
module.exports = class BidPackage extends BaseController {
  ...
  async adminside_bid_detail(req, res) {
    try {
      ...
      const baseHotelPhotoURL = "https://travel-ai-harsh.onrender.com/images/hotel_itienrary/";
      const photoBaseURL = "https://travel-ai-harsh.onrender.com/images/itinary/";
  ...
  //     const agencyLogoBaseURL = "https://travel-ai-harsh.onrender.com/images/agency/"
  ...
  async displayUserBidPackage_jaydev(req, res) {
    try {
      ...
      const baseURL = "https://travel-ai-harsh.onrender.com/images/agency/";
